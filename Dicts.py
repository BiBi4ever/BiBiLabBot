...
callback_data_keyboard_Acid={'Выделение ДНК по Хомчински':'днк_по_Хомчински_экстракция_выделение',
                        'Выделение ДНК на магнитах':'Magnitnye_Chastitsy_днк_экстракция_выделение_магнитные_частицы',
