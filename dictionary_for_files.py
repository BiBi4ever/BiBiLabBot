...
'обратная транскрипция reverse transcription MMLV cDNA кДНК' : 'https://drive.google.com/file/d/1uZr7I87Ow6VqzTTBqg_0OzuriqUm-Ip-/view',
'обычная пцр usual PCR' : 'link2',
'реал тайм real time пцр с зондом rt-PCR with zond' : 'link3',
'реал тайм real time пцр sybr green rt-PCR with SG' : 'link4'
}
